...
import { faSun, faMoon, faArrowAltCircleDown, faArrowDown, faCode, faBars, faUser} from "@fortawesome/free-solid-svg-icons"
        ...
        <div className="page home" colormode={String(colorMode)}>
            <header>
                ...
                <div className="options">
                    ...
                    <button><a href={baseUrl+"/login"}>Login <FontAwesomeIcon icon={faUser} /></a></button>
